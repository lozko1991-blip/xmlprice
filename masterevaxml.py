...
CUSTOM_MARKUP = {
    "dropt.in.ua": {
        ...
        "markup_tiers": [
            ...
            (500,    1.25,  50),   # до 500 грн     → поточна (не змінюємо)
            (1000,   1.20,  50),   # 500–1000 грн
            (2000,   1.15,  30),   # 1000–2000 грн
            (4000,   1.15,  20),   # 2000–4000 грн
            (8000,   1.15,  70),   # 4000–8000 грн
            (999999, 1.15,  70),   # вище 8000 грн
        ],
    },
    "opt-drop.com": {
        "markup_percent": 1.35,
    ...
    "www.shkatulka.in.ua": {    # URL має www. — ключ теж має бути з www.
        ...
        "markup_fixed":   40,
        "markup_tiers": [
            (500,    1.40,  40),   # до 500 грн     → поточна
